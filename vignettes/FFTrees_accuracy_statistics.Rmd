...
Note the 2x2\ table in the bottom-left corner of the plot: 
...
```{r confusion-table, echo = FALSE, out.width="50%", fig.cap = "**Figure 2**: A 2x2 matrix illustrating the frequency counts of 4 possible outcomes."}
